...
import jp.ac.it_college.std.s22001.mdia3servicesample.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun playSample() {
        ...
        controller.setMediaItem(
            MediaItem.fromUri("android.resource://${packageName}/${R.raw.takibi}")
        )
